...
const entity = z.object({
  ...
  combatStatsPublic: z.string().max(12000).default(''),
  combatStatsGm: z.string().max(12000).default(''),
  statusEffectsPublic: z.string().max(12000).default(''),
  statusEffectsGm: z.string().max(12000).default(''),
  currentHealthText: z.string().max(80).default(''),
  maxHealthText: z.string().max(80).default(''),
